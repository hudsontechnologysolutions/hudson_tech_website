...
(function () {
  const translations = {
    en: {
      ...
      'services.card2Title': 'Software Development',
      ...
      'work.museCat': 'Nonprofit Platform',
      ...
      'about.leadBio': 'Roberto is a problem-solver first, engineer second. After sharpening his craft at Pinterest, Public Service Enterprise Group, and PowerOptions, he founded Hudson Technology Solutions to do for small organizations what big-tech engineering does for the Fortune 500 — turn operational pain into measurable outcomes. Every project ships under his direct hands, from first conversation to final launch.',

      'about.bio1': 'Hudson Technology Solutions was founded by <strong>Roberto Rodas-Herndon</strong>, a Boston University Computer Science graduate. As <strong>President of BU\'s Hack4Impact chapter (2021–2023)</strong>, he led student engineers in shipping pro-bono software for under-resourced nonprofits — proving early that the right code, in the right hands, changes what an organization can actually accomplish.',
      'about.bio2': 'From building internal tooling at <strong>Pinterest\'s</strong> San Francisco headquarters to delivering data-driven insights across the enterprise at <strong>Public Service Enterprise Group</strong>, we\'ve solved problems at every scale. The lesson: the same engineering principles that move a public utility forward can transform a Main Street business — when applied by someone who actually understands the problem.',
      ...
      'timeline.role1': 'Founder & Software Engineer — Hudson Technology Solutions',
      'timeline.role2': 'Software Engineer / Data Scientist — Public Service Enterprise Group',
      'timeline.desc2': 'Replaced fragmented, manual data-pulling processes with API integrations across Redshift, Oracle, SQL Server, and third-party services — contributing to initiatives that saved <strong>9,000+ labor hours</strong> and <strong>$500K+ in operational costs</strong> at one of the largest publicly-traded utilities in the U.S.',
      'timeline.role3': 'Software Engineer Intern — PowerOptions',
      'timeline.desc3': 'Led requirements-gathering with sustainability leads, then designed and shipped <strong>3 production Python services</strong> integrating the U.S. DOE B.E.T.T.E.R. API plus interactive dashboards — enabling data-driven emissions decisions across <strong>64 properties</strong> in New England.',
      'timeline.role4': 'Software Engineer Intern — Pinterest',
      'timeline.desc4': 'Built internal observability tooling alongside <strong>6 senior engineers</strong> at Pinterest\'s San Francisco headquarters — React.js + Flask + Elasticsearch — shipping <strong>5 production features</strong> that streamed live performance analytics and improved release-readiness across engineering teams.',
      'timeline.role5': 'President — BU Hack4Impact',
      'timeline.desc5': 'Led the Boston University chapter for two years, organizing student engineers to ship free software for nonprofits that couldn\'t otherwise afford it — the experience that proved technology, well-directed, is the highest-leverage tool a mission-driven organization has.',
    ...
    es: {
      ...
      'services.card2Title': 'Desarrollo de Software',
      ...
      'timeline.role1': 'Fundador e Ingeniero de Software — Hudson Technology Solutions',
      'timeline.role2': 'Ingeniero de Software / Científico de Datos — Public Service Enterprise Group',
      'timeline.desc2': 'Reemplazó procesos manuales y fragmentados de extracción de datos con integraciones de API en Redshift, Oracle, SQL Server y servicios externos — contribuyendo a iniciativas que ahorraron <strong>9,000+ horas laborales</strong> y <strong>$500K+ en costos operativos</strong> en una de las mayores empresas de servicios públicos de EE.UU.',
      'timeline.role3': 'Ingeniero de Software (Prácticas) — PowerOptions',
      'timeline.desc3': 'Lideró la recopilación de requisitos con líderes de sostenibilidad, luego diseñó y entregó <strong>3 servicios Python en producción</strong> integrando la API B.E.T.T.E.R. del Departamento de Energía de EE.UU. más paneles interactivos — habilitando decisiones basadas en datos sobre emisiones en <strong>64 propiedades</strong> de Nueva Inglaterra.',
      'timeline.role4': 'Ingeniero de Software (Prácticas) — Pinterest',
      'timeline.desc4': 'Construyó herramientas internas de observabilidad junto a <strong>6 ingenieros senior</strong> en la sede de Pinterest en San Francisco — React.js + Flask + Elasticsearch — entregando <strong>5 funcionalidades en producción</strong> que transmitían analíticas de rendimiento en tiempo real y mejoraron la preparación de lanzamientos en los equipos de ingeniería.',
